...
### READING DATA ###
train <- read.csv("C:/Users/Admin/Documents/DataScience/PracticeProject/TitanicSinking/train.csv")
test  <- read.csv("C:/Users/Admin/Documents/DataScience/PracticeProject/TitanicSinking/test.csv")
test$Survived <- 0
