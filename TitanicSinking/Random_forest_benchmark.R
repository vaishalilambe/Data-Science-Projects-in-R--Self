...
getwd()
set.seed(1)
train <- read.csv("C:/Users/Admin/Documents/DataScience/PracticeProject/TitanicSinking/train.csv", stringsAsFactors=FALSE)
test  <- read.csv("C:/Users/Admin/Documents/DataScience/PracticeProject/TitanicSinking/test.csv",  stringsAsFactors=FALSE)
